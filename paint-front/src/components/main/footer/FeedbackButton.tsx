...
function FeedbackButton({ showAbout, setShowAbout,onFeedbackSubmitted  }: { showAbout: Boolean, setShowAbout: (showAbout: Boolean) => void,onFeedbackSubmitted: () => void }) {
  ...
  const handleSubmit = (e) => {
    ...
    try{
      ...
      onFeedbackSubmitted(); // Call the callback function to close the dialog
      console.log("Submitting feedback successfully")
      alert('Thank you');
